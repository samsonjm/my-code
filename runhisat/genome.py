...
<meta content="runhisat/genome.py · master · Samson, Jonathan / runhisat" property="og:title">
...
<meta content="https://git.wur.nl/samso008/runhisat/blob/master/runhisat/genome.py" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="runhisat/genome.py · master · Samson, Jonathan / runhisat" property="twitter:title">
...
<title>runhisat/genome.py · master · Samson, Jonathan / runhisat · GitLab</title>
...
<meta name="csrf-token" content="nMR8QhMdhmIY8OAN+dkUVdKxkzbfGQIOL7BVbjxyrwHWXP6LuPMP4oW/UbztASD50xjc9MRples4uTXhSVztMw==" />
...
<li>
<h2 class="breadcrumbs-sub-title"><a href="/samso008/runhisat/blob/master/runhisat/genome.py">Repository</a></h2>
</li>
</ul>
</div>
...
<input type="hidden" name="path" id="path" value="runhisat/genome.py" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/samso008/runhisat/blob/master/runhisat/genome.py"><strong>genome.py</strong>
</a></li>
</ul>
</div>
...
<div class="btn-group" role="group"><a class="btn js-blob-blame-link" href="/samso008/runhisat/blame/master/runhisat/genome.py">Blame</a><a class="btn" href="/samso008/runhisat/commits/master/runhisat/genome.py">History</a><a class="btn js-data-file-blob-permalink-url" href="/samso008/runhisat/blob/d537c6b471ba1277401b19b6c7da405699bac10a/runhisat/genome.py">Permalink</a></div>
</div>
</div>
...
<button class="btn btn-clipboard btn-transparent" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn-clipboard btn-transparent" data-title="Copy file path to clipboard" data-clipboard-text="{&quot;text&quot;:&quot;runhisat/genome.py&quot;,&quot;gfm&quot;:&quot;`runhisat/genome.py`&quot;}" type="button" title="Copy file path to clipboard" aria-label="Copy file path to clipboard"><svg><use xlink:href="/assets/icons-4009ebf96719f129f954d643e65f87152b5e6c4a4917130c4a696beb54af9949.svg#duplicate"></use></svg></button>
<small class="mr-1">
13.5 KB
</small>
</div>
...
<a class="js-fork-suggestion-button btn btn-grouped btn-inverted btn-success" rel="nofollow" data-method="post" href="/samso008/runhisat/blob/master/runhisat/genome.py">Fork</a>
...
<div class="blob-viewer" data-type="simple" data-url="/samso008/runhisat/blob/master/runhisat/genome.py?format=json&amp;viewer=simple">
...
<h3 class="page-title">Replace genome.py</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden="true">&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/samso008/runhisat/update/master/runhisat/genome.py" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="/u06ngwgywT96wafAC8Xq6oK1wBEDpu3V4cqa3JH6y+0dbhXp85ChGCkty4U9yMHq6OYwl9+DFJAjkrkB2mpHQ==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-c39a58af46971477fbda1c04a93db2cd">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-c39a58af46971477fbda1c04a93db2cd" class="form-control js-commit-message" placeholder="Replace genome.py" required="required" rows="3">
Replace genome.py</textarea>
</div>
</div>
</div>
